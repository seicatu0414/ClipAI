...
class Settings(BaseSettings):
    ...
    candidate_maximum_seconds: float = Field(default=900.0, ge=15, le=900)
    candidate_anchor_maximum_seconds: float = Field(default=120.0, ge=15, le=120)
    ...
    candidate_context_window_seconds: float = Field(default=600.0, ge=300, le=900)
    candidate_maximum_context_seconds: float = Field(default=1800.0, ge=600, le=3600)
    candidate_context_expansion_seconds: float = Field(default=300.0, ge=60, le=900)
    candidate_detailed_analysis_confidence: float = Field(default=0.65, ge=0, le=1)
